...
// Comprehensive static diagnostic data for Offline/Mock mode
const offlineMedicalKnowledge = [
  ...
  },
  {
    ...
    response: {
      ...
      conditions: [
        {
          ...
          confidence: 75,
          explanation: "Abdominal cramping, acidity, or general stomach pain is often caused by indigestion, acidity, or mild gastrointestinal irritation.",
          otcMedicines: [
            {
      ...
      emergencyRedFlag: false,
      emergencyAdvice: "Seek medical help if abdominal pain becomes severe and localized (e.g. lower right quadrant) or is accompanied by high fever or vomiting.",
      generalDisclaimer: "Disclaimer: This assessment is generated by an AI assistant for informational purposes only. It does not replace professional clinical evaluation."
    }
  }
];
  ...
  if (openai) {
    try {
      ...
      const prompt = `
        ...
        Respond with a JSON object. Ensure the format matches this schema exactly:
        {
          ...
          "emergencyRedFlag": false, // boolean, set to true if symptoms indicate emergency
